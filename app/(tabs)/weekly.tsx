...
const styles = StyleSheet.create({
    ...
    sectionTitle: { fontSize: 14, fontWeight: '700', color: '#555', paddingHorizontal: 16, marginTop: 8, marginBottom: 10, textTransform: 'uppercase', letterSpacing: 0.5 },
    ...
    catName: { width: 68, fontSize: 13, color: '#444' },
    barContainer: { flex: 1, height: 8, backgroundColor: '#eee', borderRadius: 4, overflow: 'hidden', marginHorizontal: 8 },
    barFill: { height: '100%', borderRadius: 4 },
    catCount: { width: 20, fontSize: 13, fontWeight: '600', color: '#555', textAlign: 'right' },
    catTime: { width: 44, fontSize: 11, color: '#888', textAlign: 'right', marginLeft: 6 },
    emptySection: { paddingHorizontal: 16, paddingVertical: 20, alignItems: 'center' },
    emptyText: { color: '#aaa', fontSize: 14 },
    logRow: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 10, backgroundColor: 'white', marginHorizontal: 12, marginBottom: 6, borderRadius: 8 },
    logTitle: { flex: 1, fontSize: 13, color: '#333' },
    ...
    logTime: { fontSize: 11, color: '#888', marginLeft: 6 },
});
