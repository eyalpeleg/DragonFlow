...
export default function EditCategoryModal({ visible, category, onClose }: Props) {
    ...
    const [selectedColor, setSelectedColor] = useState(category?.color ?? PRESET_PALETTE[0]);
            ...
            <View style={styles.overlay}>
                <View style={styles.sheet}>
                    ...
                    <View style={styles.buttons}>
                        ...
                        <Pressable
                            style={({ pressed }) => [styles.saveBtn, !canSave && styles.saveBtnDisabled, pressed && { opacity: 0.7 }]}
                            onPress={handleSave}
                            disabled={!canSave}
                        >
