...
if (fs.existsSync(manifestFile)) {
  ...
  // NOTE: the text/plain ACTION_SEND share-target intent-filter is now generated by the
  // expo-share-intent config plugin (app.json), NOT injected here — injecting it again
  // would produce a duplicate <intent-filter>. See docs/design/features/expo-share-intent-migration/.
